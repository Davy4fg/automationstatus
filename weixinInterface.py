...
class WeixinInterface:
    ...
    def POST(self):        
        ...
        if msgType == 'text':
            ...
            if content == 'a':
                return self.render.reply_text(fromUser, toUser, int(time.time()), "是https://cn.linkedin.com/in/you-li-a9081a105",'B区来自世界的商店','女王节到了，还不快去买礼物？','http://images2015.cnblogs.com/blog/785499/201603/785499-20160308110435429-590906761.png','http://www.bqu.com')
            if content == u'国家':
